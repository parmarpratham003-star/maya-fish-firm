    ...
    >
      ...
      <div className="relative z-10 px-6 max-w-4xl">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <button className="bg-blue-500 hover:bg-blue-600 px-8 py-3 rounded-md text-lg transition shadow-lg">
            🔵 Explore Our Fish
          </button>

          <button className="bg-green-500 hover:bg-green-600 px-8 py-3 rounded-md text-lg transition shadow-lg">
            🟢 WhatsApp Us Now
          </button>
