...
const fishSvgs = [
  `<svg width="70" height="35" viewBox="0 0 70 35" fill="none" xmlns="http://www.w3.org/2000/svg" style="transform: scaleX(-1);">
  ...
  `<svg width="50" height="24" viewBox="0 0 50 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="transform: scaleX(-1);">
  ...
  `<svg width="85" height="40" viewBox="0 0 85 40" fill="none" xmlns="http://www.w3.org/2000/svg" style="transform: scaleX(-1);">
  ...
  return (
    <>
      <style>{`
        ...
        /* ↓ CHANGED: min-height reduced from 100vh → 75vh */
        .hero-section {
          position: relative;
          min-height: 75vh;
          display: flex;
        ...
        /* ↓ CHANGED: padding increased top/bottom for more text breathing room */
        .hero-content {
          position: relative;
          z-index: 10;
          text-align: center;
        ...
        /* ↓ CHANGED: margin-bottom increased for more gap below eyebrow */
        .eyebrow {
          display: inline-flex;
          align-items: center;
          gap: 10px;
        ...
        .hero-h1 {
          ...
          line-height: 1.18;
          color: #ECF6FF;
          /* ↓ CHANGED: more gap between heading lines and below */
        ...
        .italic-line {
          ...
          /* ↓ CHANGED: small top gap between heading lines */
          margin-top: 0.3rem;
        }

        /* ↓ CHANGED: more top margin and bottom margin on description */
        .description {
          font-size: 0.9rem;
          color: #6D97B0;
          line-height: 1.85;
      ...
      <section className="hero-section">
        ...
        <div
          ref={raysRef}
          style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "60%", overflow: "hidden", zIndex: 1 }}
        />
